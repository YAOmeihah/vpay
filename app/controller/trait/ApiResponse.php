...
trait ApiResponse
{
    ...
    protected function respond(int $code = 1, string $msg = "成功", mixed $data = null, int $status = 200): \think\response\Json
    {
        return json($this->getReturn($code, $msg, $data), $status);
    }

    protected function success(mixed $data = null, string $msg = "成功"): \think\response\Json
    {
        return $this->respond(1, $msg, $data);
    }
